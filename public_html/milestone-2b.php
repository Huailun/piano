...
<html lang="en">
	<head>
		...
		<!-- Optional theme -->
		<link rel="css/stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap-theme.min.css" integrity="sha384-fLW2N01lMqjakBkx3l/M9EahuwpSfeNvV63J5ezn3uZzapT0u7EYsXMjQV+0En5r" crossorigin="anonymous">
			...
			<div class="container">
				<nav class="navbar navbar-default">
					...
					<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
						...
						<span class="icon-bar">Reading Music</span>
						<p><ul>
							<li>Tempo</li>
							<li>Rhythm</li>
							<li>Treble Clef, Bass Clef and Staff</li>
						</ul></p>
		...
		<section id="thumbnails">
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						<div class="thumbnail">
							<img src="http:://placekitten.com/g/100/100" alt="" class="image">
							<div class="caption">
